...
const Dashboard: React.FC = () => {
  ...
  useEffect(() => {
    ...
    } else if (!['profissional', 'aluno'].includes(normalizedType)) {
      hasRedirectedRef.current = true
  ...
  if (user) {
    const normalizedType = normalizeUserType(user.type)
    if (normalizedType === 'paciente' || normalizedType === 'admin' || !['profissional', 'aluno'].includes(normalizedType)) {
      return null
    }
  }
