        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <div className="inline-flex items-center space-x-2 bg-slate-800/80 border border-slate-700/50 rounded-full px-4 py-1.5 mb-6">
              ...
              <span className="text-xs font-bold tracking-widest text-blue-300 uppercase">AEC 001 Protocol</span>
            </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="w-full bg-slate-900 rounded-2xl p-8 border border-slate-800 relative flex flex-col h-full hover:border-green-500/50 transition-colors group">
              <div className="relative z-10 flex-grow">
                ...
                <h3 className="text-xl font-bold text-white mb-2">Plano Paciente</h3>
                <p className="text-slate-400 mb-6 text-sm">Acesso a todo ecossistema MedCannLab e Nôa Esperanza.</p>
                ...
                <div className="mb-6 border-b border-slate-800 pb-6">
                  ...
                  <p className="text-xs text-blue-400 mt-2 font-medium">+ Taxa de adesão de R$ 79,90</p>
                </div>

                <ul className="space-y-4 text-sm text-slate-300">
                  <li className="flex gap-3"><CheckCircle2 className="w-5 h-5 text-green-500 flex-shrink-0" /><span>Avaliação Clínica IMRE com IA</span></li>
                  <li className="flex gap-3"><CheckCircle2 className="w-5 h-5 text-green-500 flex-shrink-0" /><span>Acesso ao corpo clínico homologado</span></li>
                  <li className="flex gap-3"><CheckCircle2 className="w-5 h-5 text-green-500 flex-shrink-0" /><span>Relatórios estruturados da saúde</span></li>
                  <li className="flex gap-3"><CheckCircle2 className="w-5 h-5 text-green-500 flex-shrink-0" /><span>Videochamadas seguras (LGPD)</span></li>
                  <li className="flex gap-3"><CheckCircle2 className="w-5 h-5 text-green-500 flex-shrink-0" /><span>Prescrições digitais ICP-Brasil</span></li>
                </ul>
              </div>
              <button onClick={() => setShowRegister(true)} className="w-full mt-8 py-3 bg-slate-800 text-white rounded-xl font-semibold hover:bg-slate-700 transition">Assinar Paciente</button>
            </div>

            {/* Estuda / Aluno Plan */}
            <div className="w-full bg-slate-900 rounded-2xl p-8 border border-yellow-500/40 shadow-2xl relative flex flex-col h-full transform lg:-translate-y-4">
              ...
              <div className="relative z-10 flex-grow">
                ...
                <p className="text-slate-400 mb-6 text-sm">Formação, simulação de casos e acesso ao módulo de pesquisa.</p>
                ...
                <div className="mb-6 border-b border-slate-800 pb-6">
                  ...
                  <p className="text-xs text-yellow-400 mt-2 font-medium">Até R$ 229,90 (Atualizações Full + Mentorias)</p>
                </div>

                <ul className="space-y-4 text-sm text-slate-300">
                  <li className="flex gap-3"><CheckCircle2 className="w-5 h-5 text-green-500 flex-shrink-0" /><span>Acesso a todos os Cursos EAD</span></li>
                  <li className="flex gap-3"><CheckCircle2 className="w-5 h-5 text-green-500 flex-shrink-0" /><span>Simulador Clínico da Nôa IA</span></li>
                  <li className="flex gap-3"><CheckCircle2 className="w-5 h-5 text-green-500 flex-shrink-0" /><span>Módulo Avançado de Biblioteca</span></li>
                  <li className="flex gap-3"><CheckCircle2 className="w-5 h-5 text-green-500 flex-shrink-0" /><span>Aulas Ao Vivo Mensais</span></li>
                  <li className="flex gap-3"><CheckCircle2 className="w-5 h-5 text-green-500 flex-shrink-0" /><span>Fórum Global Acadêmico</span></li>
                </ul>
              </div>
              <button onClick={() => setShowRegister(true)} className="w-full mt-8 py-3 bg-gradient-to-r from-yellow-600 to-amber-600 text-white rounded-xl font-bold hover:shadow-lg transition">Assinar Aluno</button>
            </div>
            ...
            <div className="w-full bg-slate-900 rounded-2xl p-8 border border-slate-800 relative flex flex-col h-full hover:border-emerald-500/50 transition-colors group">
              <div className="relative z-10 flex-grow">
                ...
                <p className="text-slate-400 mb-6 text-sm">O arsenal completo para a condução do seu consultório.</p>
                ...
                <div className="mb-6 border-b border-slate-800 pb-6">
                  ...
                  <p className="text-xs text-emerald-400 mt-2 font-medium">SaaS B2B | Valor sugerido</p>
                </div>

                <ul className="space-y-4 text-sm text-slate-300">
                  <li className="flex gap-3"><CheckCircle2 className="w-5 h-5 text-green-500 flex-shrink-0" /><span>Agenda Compartilhada</span></li>
                  <li className="flex gap-3"><CheckCircle2 className="w-5 h-5 text-green-500 flex-shrink-0" /><span>Prontuário Eletrônico (PEP)</span></li>
                  <li className="flex gap-3"><CheckCircle2 className="w-5 h-5 text-green-500 flex-shrink-0" /><span>Pré-triagem Ilimitada via Nôa</span></li>
                  <li className="flex gap-3"><CheckCircle2 className="w-5 h-5 text-green-500 flex-shrink-0" /><span>Assinatura Digital Cloud (ICP-Brasil)</span></li>
                  <li className="flex gap-3"><CheckCircle2 className="w-5 h-5 text-green-500 flex-shrink-0" /><span>Suporte prioritário da plataforma</span></li>
                </ul>
              </div>
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl mx-auto">
              ...
              >
                <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-blue-600/20 to-cyan-600/20 flex items-center justify-center group-hover:scale-110 transition-transform">
              ...
              <button
                ...
                className="group flex items-center gap-4 p-6 rounded-2xl bg-slate-800/50 border border-slate-700/50 hover:border-green-500/40 hover:bg-slate-800/80 transition-all duration-300"
              >
                <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-purple-600/20 to-pink-600/20 flex items-center justify-center group-hover:scale-110 transition-transform">
