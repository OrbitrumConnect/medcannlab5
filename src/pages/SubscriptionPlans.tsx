      ...
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {plans.map((plan, index) => (
            <div
              key={plan.id}
              className={`bg-slate-800 rounded-xl p-8 border-2 transition-all hover:scale-105 ${index === 1
                  ? 'border-emerald-500 border-4 shadow-xl shadow-emerald-500/20'
            ...
            >
              ...
              <button
                ...
                className={`w-full py-3 rounded-lg font-semibold transition-all ${index === 1
