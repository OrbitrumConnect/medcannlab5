...
import EnsinoDashboard from './EnsinoDashboard'
import { ProfessionalFinancial } from './ProfessionalFinancial'
...
const AdminDashboard: React.FC = () => {
  ...
  const tabs = useMemo(() => ([
    ...
    { id: 'courses', label: 'Produção Aulas', icon: FileText },
    { id: 'ensino', label: 'Eixo Ensino', icon: GraduationCap },
    ...
    <div className="min-h-screen bg-[#050914] text-white">
      <div className="max-w-full mx-auto p-4 sm:p-6 space-y-6">
        ...
        <div className="bg-[#0f172a]/50 backdrop-blur-md rounded-2xl border border-slate-800/50 shadow-xl">
          <nav className="flex gap-1.5 p-2 overflow-x-auto scrollbar-hide" style={{ WebkitOverflowScrolling: 'touch' }}>
            {tabs.map((t) => {
              const Icon = t.icon
