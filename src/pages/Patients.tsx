...
const Patients: React.FC = () => {
  ...
  const patients = [
    ...
    },
    {
      ...
      priority: 'high',
      crm: '12345-SP',
      notes: 'Em tratamento oncológico, acompanhamento especializado.',
      bloodType: 'AB+',
    ...
    },
    {
      ...
      priority: 'high',
      crm: '12345-SP',
      notes: 'Controle de crises com CBD, evolução positiva.',
      bloodType: 'B-',
      allergies: ['Nenhuma'],
    ...
    },
    {
      ...
      priority: 'high',
      crm: '12345-SP',
      notes: 'Melhora dos tremores com THC, acompanhamento neurológico.',
      bloodType: 'AB-',
      allergies: ['Nenhuma'],
