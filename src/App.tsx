...
import { ClinicalGovernanceProvider } from './contexts/ClinicalGovernanceContext'
...
import DRCMonitoringSchedule from './pages/DRCMonitoringSchedule'
                    ...
                    <ClinicalGovernanceProvider>
                      <Routes>
                        ...
                        <Route path="/app" element={
                          ...
                          {/* Rotas legadas → redirect para canônica (componentes preservados) */}
                          <Route path="eduardo-faveret-dashboard" element={<Navigate to="/app/clinica/profissional/dashboard" replace />} />
                          <Route path="ricardo-valenca-dashboard" element={<Navigate to="/app/clinica/profissional/dashboard" replace />} />
                          ...
                          {/* Rota legada Eduardo → redirect para canônica */}
                          <Route path="clinica/profissional/dashboard-eduardo" element={<Navigate to="/app/clinica/profissional/dashboard" replace />} />
                          ...
                          <Route path="ensino/profissional/aula/:moduleId/:lessonId" element={<LessonDetail />} />
                          ...
                          {/* EIXO PESQUISA */}
                          <Route path="pesquisa/profissional/dashboard" element={<PesquisaDashboard initialTab="dashboard" />} />
                          <Route path="pesquisa/profissional/forum-casos" element={<PesquisaDashboard initialTab="forum" />} />
                          <Route path="pesquisa/profissional/cidade-amiga-dos-rins" element={<PesquisaDashboard initialTab="renal" />} />
                          ...
                          {/* Rotas Legadas → Redirect para canônicas */}
                          <Route path="patient-dashboard" element={<Navigate to="/app/clinica/paciente/dashboard" replace />} />
                          <Route path="patient-agenda" element={<Navigate to="/app/clinica/paciente/agendamentos" replace />} />
                          <Route path="patient-kpis" element={<Navigate to="/app/clinica/paciente/dashboard" replace />} />
                          <Route path="professional-dashboard" element={<Navigate to="/app/clinica/profissional/dashboard" replace />} />
                          <Route path="aluno-dashboard" element={<Navigate to="/app/ensino/aluno/dashboard" replace />} />
                          <Route path="clinica-dashboard" element={<Navigate to="/app/clinica/profissional/dashboard" replace />} />
                          <Route path="ensino-dashboard" element={<Navigate to="/app/ensino/profissional/dashboard" replace />} />
                          <Route path="pesquisa-dashboard" element={<Navigate to="/app/pesquisa/profissional/dashboard" replace />} />
                          ...
                          <Route path="professional-scheduling" element={<Navigate to="/app/clinica/profissional/agendamentos" replace />} />
                          <Route path="patient-appointments" element={<Navigate to="/app/clinica/paciente/agendamentos" replace />} />
                          <Route path="patient-noa-chat" element={<Navigate to="/app/clinica/paciente/chat-noa" replace />} />
                          <Route path="clinical-assessment" element={<Navigate to="/app/clinica/paciente/avaliacao-clinica" replace />} />
                          <Route path="professional-chat" element={<Navigate to="/app/clinica/profissional/chat-profissionais" replace />} />
                          <Route path="subscription-plans" element={<SubscriptionPlans />} />
                          <Route path="checkout" element={<PaymentCheckout />} />
                          <Route path="patient-financial" element={<PatientFinancialDashboard />} />
