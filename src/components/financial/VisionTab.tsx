  ...
  return (
    <div className="space-y-6">
      <div className="bg-gradient-to-r from-green-900/30 to-blue-900/30 border border-green-500/30 rounded-xl p-6">
        <h2 className="text-2xl font-bold text-brand-text mb-6">🌱 Modelo de Negócio Sustentável - Nôa Esperanza</h2>
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={title} className="flex items-start gap-2">
                  ...
                  <div>
                    <h4 className="text-brand-text font-semibold text-sm">{title}</h4>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          <div className="bg-brand-surface rounded-lg p-4 border border-green-500/20">
            <h4 className="text-gray-400 text-xs mb-1">Receita Recorrente</h4>
            <p className="text-2xl font-bold text-green-400">0%</p>
          </div>
          <div className="bg-brand-surface rounded-lg p-4 border border-blue-500/20">
            <h4 className="text-gray-400 text-xs mb-1">Parcerias Ativas</h4>
            <p className="text-2xl font-bold text-blue-400">12+</p>
          </div>
          <div className="bg-brand-surface rounded-lg p-4 border border-purple-500/20">
            <h4 className="text-gray-400 text-xs mb-1">Redução Carbono</h4>
            <p className="text-2xl font-bold text-purple-400">-23%</p>
          </div>
          <div className="bg-brand-surface rounded-lg p-4 border border-orange-500/20">
