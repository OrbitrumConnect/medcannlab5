        ...
        <div className="bg-slate-900/40 border border-white/5 rounded-2xl p-6 backdrop-blur-xl space-y-4">
            ...
            <div className="relative">
                ...
                <input
                    ...
                    className="w-full bg-slate-950/50 border border-white/10 rounded-xl py-3 pl-11 pr-4 text-brand-text placeholder-slate-500 focus:outline-none focus:border-primary-500/50 transition-all"
                />
            </div>
                        ...
                        >
                            <div className="flex items-center gap-4">
                                ...
                                <div className="text-left">
                                    <p className="text-brand-text font-semibold group-hover:text-primary-400 transition-colors">{patient.name}</p>
