    ...
    <>
        ...
        <>
          ...
          <div className={clsx('fixed z-50 flex flex-col items-center', positionClasses)}>
            ...
            <button
              ...
              className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-full shadow-xl transition-all duration-300 flex items-center justify-center overflow-visible hover:scale-110 relative"
              style={{
            ...
            >
              ...
              <div className="relative z-10 w-full h-full rounded-full flex items-center justify-center overflow-hidden">
                <img 
                  src="/brain.png" 
                  alt="MedCannLab Logo" 
                  className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 object-contain p-1"
                  style={{
      ...
      {isOpen && (
        <div className={clsx(
          ...
          isExpanded 
            ? 'left-2 sm:left-4 md:left-[80px] lg:left-[320px] right-2 sm:right-4 top-2 sm:top-4 bottom-2 sm:bottom-4' // Expandido: no mobile ocupa quase toda a tela
            : position === 'bottom-right' 
              ? 'bottom-2 sm:bottom-4 right-2 sm:right-4 w-[calc(100vw-1rem)] sm:w-[calc(100vw-2rem)] md:w-[600px] h-[calc(100vh-1rem)] sm:h-[calc(100vh-2rem)] md:h-[720px] max-h-[calc(100vh-1rem)] sm:max-h-[calc(100vh-2rem)]'
              : position === 'bottom-left'
                ? 'bottom-2 sm:bottom-4 left-2 sm:left-4 w-[calc(100vw-1rem)] sm:w-[calc(100vw-2rem)] md:w-[600px] h-[calc(100vh-1rem)] sm:h-[calc(100vh-2rem)] md:h-[720px] max-h-[calc(100vh-1rem)] sm:max-h-[calc(100vh-2rem)]'
                : position === 'top-right'
                  ? 'top-2 sm:top-4 right-2 sm:right-4 w-[calc(100vw-1rem)] sm:w-[calc(100vw-2rem)] md:w-[600px] h-[calc(100vh-1rem)] sm:h-[calc(100vh-2rem)] md:h-[720px] max-h-[calc(100vh-1rem)] sm:max-h-[calc(100vh-2rem)]'
                  : 'top-2 sm:top-4 left-2 sm:left-4 w-[calc(100vw-1rem)] sm:w-[calc(100vw-2rem)] md:w-[600px] h-[calc(100vh-1rem)] sm:h-[calc(100vh-2rem)] md:h-[720px] max-h-[calc(100vh-1rem)] sm:max-h-[calc(100vh-2rem)]'
        )}>
          <div className="bg-gradient-to-r from-emerald-600 via-emerald-500 to-sky-500 px-3 sm:px-4 md:px-5 py-3 sm:py-4 flex items-center justify-between">
            <div className="flex items-center space-x-2 sm:space-x-3 min-w-0 flex-1">
              <NoaAnimatedAvatar size={isExpanded ? "lg" : "md"} isListening={isListening} isSpeaking={isSpeaking} />
              <div className="min-w-0 flex-1">
                <p className="text-xs sm:text-sm text-emerald-100 truncate">Nôa Esperança • IA Residente</p>
                <p className="text-[10px] sm:text-xs text-emerald-50/80 truncate">{userName} • {userCode}</p>
              </div>
            </div>
          ...
          <div className="border-b border-slate-800 bg-slate-900/80 px-3 sm:px-4 md:px-5 py-2 flex items-center justify-between text-xs text-slate-400">
          ...
          <div ref={scrollContainerRef} className="flex-1 overflow-y-auto px-3 sm:px-4 md:px-5 py-3 sm:py-4 space-y-3 sm:space-y-4">
          ...
          <div className="border-t border-slate-800 bg-slate-900/80 px-3 sm:px-4 md:px-5 py-2 sm:py-3 space-y-2">
            {error && (
