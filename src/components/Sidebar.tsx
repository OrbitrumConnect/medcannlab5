...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  const getNavigationItems = () => {
    const adminItems = [
      ...
      {
        name: 'Terminal de Ensino',
        href: '/app/ensino/aluno/dashboard?section=aulas',
        icon: GraduationCap,
        section: 'main',
        color: 'bg-green-600'
      },
      ...
      },
      {
        ...
        href: '/app/ensino/profissional/gestao-alunos',
        icon: Users,
        section: 'main',
        color: 'bg-teal-600'
      },
    ...
    const studentItems = [
      { name: 'Terminal de Ensino', href: '/app/ensino/aluno/dashboard?section=aulas', icon: LayoutDashboard },
      { name: 'Catálogo de Cursos', href: '/app/ensino/aluno/cursos', icon: BookOpen },
  ...
  const ensinoSections: AxisSection[] = [
    {
      ...
      icon: GraduationCap,
      href: '/app/ensino/profissional/dashboard?section=aulas'
    },
    {
      id: 'biblioteca',
      label: 'Biblioteca',
    ...
    },
    {
      ...
      icon: CheckCircle,
      href: '/app/ensino/profissional/dashboard?section=avaliacao'
    },
    {
      id: 'newsletter',
      ...
      icon: Bell,
      href: '/app/ensino/profissional/dashboard?section=newsletter'
    },
    {
      ...
      icon: MessageCircle,
      href: '/app/ensino/profissional/dashboard?section=chat-profissionais'
    }
  ]
  ...
  const pesquisaSections: AxisSection[] = [
    {
      ...
      description: 'Estação de trabalho integrada',
      icon: TerminalIcon,
      href: '/app/pesquisa/profissional/dashboard'
    }
  ]
  ...
  const axisConfigs = [
    ...
    // Profissional não vê mais o eixo de Ensino no sidebar (apenas via Dashboard ADM se tiver acesso)
    if (normalizedType === 'profissional' && axis.key === 'ensino') return false
    return true
  })
  ...
  return (
    <>
      ...
      <div className={`text-white transition-all duration-300 flex flex-col fixed left-0 top-0 z-50 overflow-x-hidden ${mobileOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'
        ...
        {/* Sino de notificações movido para o Header (ao lado do BR/idioma) */}
        ...
        >
          {(() => {
            ...
            <>
              {/* Meu Dashboard - Profissionais e Admin (Dr. Ricardo, Eduardo, etc.) — primeiro trigger do sidebar */}
              ...
              {/* Seletor de Eixos - No Topo - Apenas para alunos, os demais usam fila única */}
              {normalizedType === 'aluno' && (
