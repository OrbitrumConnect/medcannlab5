...
export const getDefaultRouteByType = (type: UserType): string => {
  const routes = {
    ...
    'profissional': '/app/clinica/profissional/pacientes', // Prontuário Eletrônico - Gestão de Pacientes e Atendimentos
    'paciente': '/app/clinica/paciente/dashboard',
    'admin': '/app/clinica/profissional/pacientes', // Admin também usa Prontuário Eletrônico
  }
