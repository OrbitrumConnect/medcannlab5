 ...
 * 
 * Derives clinical scores from AEC protocol data stored in clinical_reports.content
...
export interface ClinicalScores {
  clinical_score: number       // 0-100 overall clinical score
  treatment_adherence: number  // 0-100 treatment adherence
  quality_of_life: number      // 0-100 quality of life
  symptom_improvement: number  // 0-100 symptom improvement
