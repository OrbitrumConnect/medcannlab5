...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      clinical_axes: {
        Row: {
          ...
          patient_id: string
          report_id: string
          source_rationality_id: string | null
          summary: string
          updated_at: string | null
        }
        Insert: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "clinical_axes_report_id_fkey"
            columns: ["report_id"]
            isOneToOne: false
            referencedRelation: "clinical_reports"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "clinical_axes_source_rationality_id_fkey"
            columns: ["source_rationality_id"]
            isOneToOne: false
      ...
      clinical_kpis: {
        ...
        Relationships: [
          {
            foreignKeyName: "clinical_kpis_axis_id_fkey"
            columns: ["axis_id"]
            isOneToOne: false
            referencedRelation: "clinical_axes"
            referencedColumns: ["id"]
          },
          {
          ...
          {
            foreignKeyName: "clinical_kpis_rationality_id_fkey"
            columns: ["rationality_id"]
            isOneToOne: false
            referencedRelation: "clinical_rationalities"
            referencedColumns: ["id"]
          },
      ...
      clinical_rationalities: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "clinical_rationalities_report_id_fkey"
            columns: ["report_id"]
            isOneToOne: false
            referencedRelation: "clinical_reports"
            referencedColumns: ["id"]
      ...
      noa_logs: {
        ...
        Relationships: [
          {
            foreignKeyName: "noa_logs_appointment_id_fkey"
            columns: ["appointment_id"]
            isOneToOne: false
            referencedRelation: "appointments"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "noa_logs_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "v_auth_activity"
            referencedColumns: ["id"]
      ...
      video_call_quality_logs: {
        Row: {
          appointment_id: string | null
          bitrate_kbps: number | null
          connection_state: string | null
          id: string
          is_watchdog_trigger: boolean | null
        ...
        Relationships: [
          {
            foreignKeyName: "video_call_quality_logs_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "v_auth_activity"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      backfill_clinical_kpis: { Args: never; Returns: undefined }
      ...
      log_institutional_trauma: {
        Args: {
          p_affected_domain?: string
          p_metadata?: Json
          p_reason: string
          p_recovery_estimated_at?: string
          p_severity: string
        }
        Returns: string
      }
