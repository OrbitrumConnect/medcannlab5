...
**Versão:** 0.3 DRAFT pré-consultora SaMD (atualizado com 2 novos docs + Executive Summary)
**Status:** Concatenação de 16 drafts + Executive Summary + README
**Propósito:** facilitar copy-paste integral para consultora / RT / arquivo único

**Sumário:**

0. EXECUTIVE_SUMMARY — Sumário executivo 5-10 páginas (mais importante para consultora)
...
<a name="15_plan-flip-verify-jwt"></a>
...
<a name="16_pln-ver-001_plano_de_verificacao"></a>
